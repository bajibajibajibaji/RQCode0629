...
+ (NSString *)adaptiveImagePathWithPNGImageName:(NSString *)fullImageName
{
    return [[NSBundle mainBundle] pathForResource:[fullImageName adaptiveImageName] ofType:@"png"];
}
